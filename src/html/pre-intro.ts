export const preIntroScreenHTML = `
  <div class="container">
    <div id="pre-intro-text" >
        ...
        <p>Now, as the player of 'Attack of the Space Nerds,' you must take on the role of a lone survivor of the destroyed spaceship, equipped only with a basic spacecraft and weapons. Your mission is to defend yourself against the nerds from outer space and save the world from their destructive attacks.</p> 
        <p>As you journey through space, you must fight off the nerds and dodge their bombs, using your skill and cunning to outmaneuver them. You are the last hope for the galaxy, and the fate of the universe rests on your shoulders.</p>
        <p>Will you rise to the challenge and save the world, or will you fall to the relentless onslaught of the space nerds? The fate of the galaxy is in your hands.</p>
        </div>
